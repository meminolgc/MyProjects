				...
				Headers =
	{
		...
		{ "x-rapidapi-host", "akaryakit-fiyatlari.p.rapidapi.com" },
			...
			using (var response = await client.SendAsync(request))
			{
				...
				//string cleanedValue = gasolineJsonValue.Replace("₺");
				...
				//dieselPrice = double.Parse(dieselJsonValue.ToString(), new CultureInfo("tr-TR"));
				//gasolinePrice = double.Parse(gasolineJsonValue.ToString(), new CultureInfo("tr-TR"));
				//lpgPrice = double.Parse(lpgJsonValue.ToString(), new CultureInfo("tr-TR"));
